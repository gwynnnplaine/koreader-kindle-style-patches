...
ReaderView.paintTo = function(self, bb, x, y)
    ...
    local header_top_padding = 12 -- replace small with default or large for more space at the top
    ...
    -- gwynplaine's change - Centered header with time only
